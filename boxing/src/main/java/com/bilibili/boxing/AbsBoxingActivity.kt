 ...
 * @author ChenSL
 */
abstract class AbsBoxingActivity : AppCompatActivity(),
    Boxing.OnBoxingFinishListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val view =
            onCreateBoxingView(getSelectedMedias(intent))
        val pickerConfig = BoxingManager.getInstance().boxingConfig
    ...
    val boxingConfig: BoxingConfig
        get() = BoxingManager.getInstance().boxingConfig

    /**
     * create a [com.bilibili.boxing.presenter.PickerContract.View] attaching to
     * [com.bilibili.boxing.presenter.PickerContract.Presenter],call in [.onCreate]
     */
