...
@WorkerThread
class VideoTask :
    IMediaTask<VideoMedia> {
    override fun load(
        cr: ContentResolver,
        page: Int,
        id: String,
        callback: IMediaTaskCallback<VideoMedia>
    ) {
    ...
    private fun loadVideos(
        ...
        val videoMedias: MutableList<VideoMedia> =
            ArrayList()
        var count: Int
        val videoCursor = cr.query(
        ...
        videoCursor?.use { cursor ->
            if (cursor.moveToFirst()) {
                ...
                do {
                    ...
                    val video =
                        VideoMedia.Builder(id, data)
                            .setTitle(title).setDuration(duration)
